...
function vectorCreator(parsedData, vmin, vmax, title, colorbarKey, key='velocity') {
    ...
    const scale = 1500, arrowLength = 1;
...
function changeVector(object) {
    // Check if selected value is "Velocity"
    if (object.value === "Velocity") {
        initiateVelocities(vectorObjectSubmain);
...
initiateVelocities(velocityObject);
initiateLayers();
